...
<template>
    ...
    <div class=" p-[80px] w-1024:p-[50px] w-640:p-[30px] bg-default grid gap-[30px]">
        ...
        <div class="grid grid-cols-[500px_1fr_max-content] w-1280:grid-cols-[385px_1fr_max-content] gap-10 w-1024:grid-cols-1">

            <div class="bg-white p-9 rounded-[20px] grid gap-12 w-1024:gap-8 w-1024:p-7">

                <div class="grid grid-cols-[max-content_1fr] gap-5 w-1024:gap-4 w-640:grid-cols-[max-content] w-640:justify-center w-640:justify-items-center">
                    
                    <div class="p-3 w-1024:p-2 bg-default-60 rounded-md w-1024:rounded w-max">
                        <img class="w-[45px]" src="assets/img/tg.png"/>
                    </div>
                    
                    <div class="grid gap-2 w-640:justify-items-center">

                        <h4 class=" font-semibold text-[24px] w-1280:text-[21px] w-750:text-[19px]">Telegram</h4>

                        <div class="grid grid-cols-[max-content_max-content] content-center gap-3">
                            
                            <span class="text-[19px] w-1280:text-[18px] w-750:text-[16px]">
                               t.me/Svetlana_Mi6
                            </span>
                            
                            <div class="w-[25px] w-1280:w-[22px] w-750:w-[20px] cursor-pointer">
                ...
                <div class="grid grid-cols-[max-content_1fr] gap-5 w-1024:gap-4 w-640:grid-cols-[max-content] w-640:justify-center w-640:justify-items-center">
                    ...
                    <div class="grid gap-2 w-640:justify-items-center">
                        ...
                        <h4 class=" font-semibold text-[24px] w-1280:text-[21px] w-750:text-[19px]">Электронная почта</h4>
